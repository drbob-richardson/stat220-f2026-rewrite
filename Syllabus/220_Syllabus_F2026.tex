...
\begin{tabular}{ l l }
  ...
  & \hspace{5mm} \large Office Hours: TBD \\
  & \hspace{5mm} \large 801-422-3736 \\
\end{tabular}
\vspace{5mm}

\begin{tabular}{ l l }
  \multirow{2}{*}{} & \large TAs: TBD \\
  & \hspace{5mm} \large Names, emails, and office hours will be posted on Learning Suite. \\
\end{tabular}
\vspace{5mm}
...
\item (Optional) \textbf{Weapons of Math Destruction} by Cathy O'Neil. A pointed, sometimes
  overstated look at how models get used and misused on real people. Worth reading. It is no
  longer tied to a graded assignment.
\end{itemize}
...
Course material is on GitHub at \url{https://github.com/drbob-richardson/stat220}. Please make
sure you have a GitHub account, since you will link it to your name in the first homework.
...
\item \textbf{Statistical Inference in the Wild.} Signal against noise, standard error, the
