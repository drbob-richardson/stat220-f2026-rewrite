#!/usr/bin/env python3
"""Unit 4: Building and Trusting a Model. Code companion and homework."""
from nblib import CodeNB, HW

# =====================================================================
# CODE COMPANION
# =====================================================================
nb = CodeNB(4, "Building and Trusting a Model",
...
nb.write("Code_Unit04_Model_Building.ipynb")


# =====================================================================
# HOMEWORK
# =====================================================================
hw = HW(4, "Building and Trusting a Model",
...
hw.write("Stat_220_HW_Unit04_Model_Building.ipynb")
